...
import kai.lu.rocketmq.flink.source.util.ByteSerializer;
import kai.lu.rocketmq.flink.source.util.ByteSerializer.ValueType;
import kai.lu.rocketmq.flink.source.util.StringSerializer;
...
public class RowDeserializationSchema implements DeserializationSchema<List<BytesMessage>, RowData> {
            ...
            if (hasMetadata) {
                ...
                for (int index = 0; index < metadataArity; index++) {
                    producedRow.setField(
                            index + physicalArity,
                            metadataConverters[index].read(message)
                    );
                }
    ...
    public static class Builder {
        ...
        public void setFormatErrorStrategy(DirtyDataStrategy formatErrorStrategy) {
            this.formatErrorStrategy = formatErrorStrategy;
        }

        public void setFieldMissingStrategy(DirtyDataStrategy fieldMissingStrategy) {
            this.fieldMissingStrategy = fieldMissingStrategy;
        }

        public void setFieldIncrementStrategy(DirtyDataStrategy fieldIncrementStrategy) {
            this.fieldIncrementStrategy = fieldIncrementStrategy;
        }
        ...
        public void setColumnErrorDebug(boolean columnErrorDebug) {
            this.columnErrorDebug = columnErrorDebug;
        }
        ...
        public Builder setProperties(Map<String, String> properties) {
            ...
            String lengthCheck = configuration.get(RocketMQOptions.LENGTH_CHECK);
            ...
            this.setEncoding(configuration.getString(RocketMQOptions.ENCODING));
            this.setFieldDelimiter(configuration.getString(RocketMQOptions.FIELD_DELIMITER));
            this.setLineDelimiter(configuration.getString(RocketMQOptions.LINE_DELIMITER));
            this.setColumnErrorDebug(configuration.getBoolean(RocketMQOptions.COLUMN_ERROR_DEBUG));
