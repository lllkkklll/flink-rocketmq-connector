...
/**
 * A {@link TransactionMQProducer} that exposes private fields to allow resume producing from a given state.
 */
public class FlinkRocketMQInternalProducer extends TransactionMQProducer {

    private static final Logger LOG = LoggerFactory.getLogger(FlinkRocketMQInternalProducer.class);
    ...
    public FlinkRocketMQInternalProducer(Properties properties, @Nullable String transactionalId) {
